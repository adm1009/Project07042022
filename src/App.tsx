  ...
  render() {
    return (
      <div>
        ...
        <section>
          <Routes>
            <Route path="/" element={<Home username={this.handleuser} password="" show showError/>} />
            <Route
              path="/logout"
              element={
                <PrivateRoute>
            ...
            <Route
              ...
              element={
                <PrivateRoute>
                  <Navbar personalData leaveData employeeData username={this.state.username} />
                </PrivateRoute>
              }
            />
            <Route
            ...
            <Route
              ...
              element={
                <PrivateRoute>
                  <DailyAttendance entry exit msg datesData="" timesData="" username={this.state.username}/>
                </PrivateRoute>
              }
            />
            <Route
            ...
            <Route
              ...
              element={
                <PrivateRoute>
                  <EmployeeAppraisalForm duration="" goals="" skills="" show username={this.state.username}/>
                </PrivateRoute>
              }
            />
            <Route
              ...
              element={
                <PrivateRoute>
                  <LeaveData date="" reason="" show username={this.state.username}/>
                </PrivateRoute>
              }
            />
            <Route
            ...
            <Route
              ...
              element={
                <PrivateRoute>
                  <MyRegularize username={this.state.username}/>
                </PrivateRoute>
              }
            />
            <Route
